            ...
            <div class="contact-form">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="first_name" value="<?php if (isset($_POST['first_name'])) echo htmlspecialchars($_POST['first_name']); ?>" id="first_name" placeholder="First Name" >
                        <!-- err -->
                        ...
                        <input type="text" name="last_name" value="<?php if (isset($_POST['last_name'])) echo htmlspecialchars($_POST['last_name']); ?>" id="last_name" placeholder="Last Name" >
                        ...
                        <input type="email" name="email" value="<?php if (isset($_POST['email'])) echo htmlspecialchars($_POST['email']); ?>" id="email" placeholder="Email" >
                        ...
                        <textarea name="comments" id="comments" placeholder="Comments" ><?php if (isset($_POST['comments'])) echo htmlspecialchars($_POST['comments']); ?></textarea>
                        ...
                        <hr />
                        <label id="privacy" for="privacy">I agree to the privacy policy <input value="yes" type="checkbox" name="privacy" id="privacy"  <?php if (isset($_POST['privacy']) && $_POST['privacy'] == 'yes') echo 'checked="checked"'; ?>></label>
